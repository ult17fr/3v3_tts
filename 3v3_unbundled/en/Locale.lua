return {
    ...
    lietSandwormConfirm = "Get 1 spice, 1 intrigue and 1 trash\ninstead of sandworm?",
    panopticonSpy = "PANOPTICON SPY!",
    killSardaukarCommanderConfirm = "Kill Sardaukar Commander?\n(costs 2 spice and get 1 intrigue)",
    killSardaukarCommander = "↯ DESERT POWER!",
